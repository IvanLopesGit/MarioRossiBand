  ...
  return (
    <div className="about">
      ...
      <div className="about-text">
        Mario Rossi is a Brazilian guitarist and singer based on São Bernardo do
        Campo
        <br /> (São Paulo State/Brazil). He has been moving forward in music
        since 2004,
        <br /> when he was 18 years old and made his live debut. Nowadays, as a
        confident player,
        <br /> he treats riffs, licks and melodies with respect and wisdom.
        <br /> He knows where he wants to go! <br />
        The guitarist/singer started his journey improving his skills as a cover
        artist.
        ...
        Elmore James,
        <br /> B.B. King, Peter Green, Johnny Winter, Eric Clapton, and also Ray
        Charles’s
        ...
        Primer in Brazil.
        <br /> They played in cities in the South and Southeast of the country,
        <br />
        including a performance on The Noite com Danilo Gentili TV show,
        <br />
        screened by the channel SBT – one of the biggest TV channels in Brazil.
        <br />
        ...
        <br /> It’s an intense 10-track journey through Classic and Blues Rock.
        <br />
        The songs are all original ones and give us a good taste of his arsenal
        of riffs and licks
        <br /> inspired by some of the great rockers from the 60’s and the 70’s.
        <br />
